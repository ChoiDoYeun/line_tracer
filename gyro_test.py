...
def rotate_to_angle(target_angle):
    ...
    while True:
        ...
        # 디버깅 정보 출력
        print(f"Current Angle: {current_angle:.2f}°, Error: {error:.2f}, Control Signal: {control_signal:.2f}")
        print(f"P: {Kp * proportional:.2f}, I: {Ki * integral:.2f}, D: {Kd * derivative:.2f}")
